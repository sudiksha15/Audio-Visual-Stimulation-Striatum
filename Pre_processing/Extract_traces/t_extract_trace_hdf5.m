 fileDir='/home/hanlabadmins/eng_handata/Leo/GCaMP/50400-3-14-23/motion_corrected_3Hz';
 %put yout directory here
filename_list = {fileDir};
    ...
    for filename_idx = 1:numel(filename_list)
        ...
        save('/home/hanlabadmins/eng_handata/Leo/GCaMP/50400-3-14-23/motion_corrected_3Hz/trace.mat','r_out')
    end
