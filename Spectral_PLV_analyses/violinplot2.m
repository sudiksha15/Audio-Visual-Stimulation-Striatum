...
% This code is released under the terms of the BSD 3-clause license
    ...
    elseif ismatrix(data)
        alpha_val=[ 0.2 0.1 0.05];
        for n=1:size(data, 2)
            thisData = data(:, n);
            violins(n) = Violin(thisData, cats(n),varargin{1}, varargin{2}(n,:),'ViolinAlpha', alpha_val(n)); %%%%%%
        end
